...
{ 
    ...
    public class MenuViewModel
    {
        ...
        public MenuViewModel()
        {
            ...
            this.Menu.Add(new MenuItem() { Icon = new PackIconFontAwesome() { Kind = PackIconFontAwesomeKind.UserSolid }, Text = "Student", NavigationDestination = new Uri("Views/CheckView.xaml", UriKind.RelativeOrAbsolute) });
