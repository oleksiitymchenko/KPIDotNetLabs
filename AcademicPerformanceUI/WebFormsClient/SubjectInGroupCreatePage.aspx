...
<asp:Content ID="SubjectInroupCreatePage" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="dropdownSubject" runat="server" OnSelectedIndexChanged="dropdown_OnSelectedIndexChanged"></asp:DropDownList><br />
    <label>Select group</label>    
    <asp:DropDownList ID="dropdownGroup" runat="server" OnSelectedIndexChanged="dropdown_OnSelectedIndexChanged1"></asp:DropDownList><br />
